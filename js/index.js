...
(function() {
  var SavedCheckbox, SavedInput, Video, VideoList;
  ...
  VideoList = (function() {
    function VideoList(storageString1, reversed) {
      this.storageString = storageString1;
      if (reversed == null) {
        reversed = false;
      }
  ...
  SavedInput = (function() {
    function SavedInput(selector, storageString, defaultValue, listener) {
      var value;
      value = localStorage.getItem(storageString) || defaultValue;
  ...
  SavedCheckbox = (function() {
    function SavedCheckbox(selector, storageString, defaultValue, listener) {
      var value;
      value = localStorage.getItem(storageString) || defaultValue;
      localStorage.setItem(storageString, value);
  ...
  $(document).ready(function() {
    var $autoplay, $expand, $videos, addVideoToDom, historyInput, onPlayerReady, onPlayerStateChange, readDataInterval, refreshScreen, refreshTimer, title, unwatchedVideos, updateInput, watchedVideos;
